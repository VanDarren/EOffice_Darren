    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-12">
                ...
                <p class="text-muted">Formulir untuk mengelola data surat keluar.</p>
                <div class="card shadow mb-4">
                    <div class="card-header">
                        <strong class="card-title">Form Surat Keluar</strong>
                    </div>
                    <div class="card-body">
                        <form action="{{ url('aksiTambahSuratKeluar') }}" method="POST" enctype="multipart/form-data">
                            @csrf
